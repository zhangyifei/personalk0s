...
type Calico struct {
	...
	// The host path for Calicos flex-volume-driver(default: /usr/libexec/eke/kubelet-plugins/volume/exec/nodeagent~uds)
...
func DefaultCalico() *Calico {
	return &Calico{
		...
		FlexVolumeDriverPath:    "/usr/libexec/eke/kubelet-plugins/volume/exec/nodeagent~uds",

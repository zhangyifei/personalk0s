...
import (
	...
	"eke/internal/pkg/strictyaml"
)

const (
	ClusterConfigKind       = "ClusterConfig"
	ClusterConfigAPIVersion = "eke/v1beta1"
)
...
// InstallSpec defines the required fields for the `eke install` command
...
func DefaultClusterConfig(defaultStorage ...*StorageSpec) *ClusterConfig {
	...
	return &ClusterConfig{
		ObjectMeta: metav1.ObjectMeta{Name: "eke"},
		TypeMeta: metav1.TypeMeta{
			APIVersion: "eke/v1beta1",
			Kind:       "ClusterConfig",
		},
		Spec: clusterSpec,
	}
...
func (c *ClusterConfig) CRValidator() *ClusterConfig {
	copy := c.DeepCopy()
	copy.ClusterName = "eke"
	copy.ObjectMeta.Name = "eke"

...
func TestClusterDefaults(t *testing.T) {
	c, err := ConfigFromString("apiVersion: eke.ekeproject.io/v1beta1")
...
apiVersion: eke.ekeproject.io/v1beta1
kind: ClusterConfig
unknown: 1`)
...
`
	...
	assert.Equal(t, "https://foo.bar.com:9443", c.Spec.API.EkeControlPlaneAPIAddress())
}
...
`
	...
	assert.Equal(t, "https://1.2.3.4:9443", c.Spec.API.EkeControlPlaneAPIAddress())
}

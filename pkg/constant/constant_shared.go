...
const WinDataDirDefault = "C:\\var\\lib\\eke"
...
const (
	...
	DefaultPSP = "00-eke-privileged"
	// Image Constants
	KonnectivityImage                  = "quay.io/ekeproject/apiserver-network-proxy-agent"
	KonnectivityImageVersion           = "0.0.30-eke"
	PushGatewayImage                   = "quay.io/ekeproject/pushgateway-ttl"
	...
	KubeRouterCNIInstallerImage        = "quay.io/ekeproject/cni-node"
	...
	ClusterConfigObjectName = "eke"

	NodeRoleLabelNamespace = "node-role.kubernetes.io"
)

// CfgVars is a struct that holds all the config variables required for Eke
type CfgVars struct {
	...
	DataDir                    string // Data directory containing eke state

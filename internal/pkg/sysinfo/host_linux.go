...
import (
	...
	"eke/internal/pkg/sysinfo/probes/linux"
)

func (s *EkeSysinfoSpec) addHostSpecificProbes(p probes.Probes) {
...
func (s *EkeSysinfoSpec) addKernelConfigs(linux *linux.LinuxProbes) {
	...
	// comparing the output of `lsmod` before and after running eke.
